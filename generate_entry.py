...
# Define the new content structure based on xeroVsQuickBooksEntry.ts content and is-xero-worth-it metadata
new_post = {
    "id": "is-xero-worth-it",
    "slug": "is-xero-worth-it",
    "title": "Is Xero Worth It? A CPA's Honest Cost-Benefit Analysis",
...
<p><a href="/contact/"><strong>Book Free Consultation →</strong></a></p>""",
    "toc": [
        ...
        { "id": "pricing-comparison-the-real-cost", "title": "Pricing Comparison: The Real Cost" },
        { "id": "gst-hst-compliance-both-handle-it-well", "title": "GST/HST Compliance: Both Handle It Well" },
        { "id": "ease-of-use-xero-wins-on-design", "title": "Ease of Use: Xero Wins on Design" },
        { "id": "payroll-quickbooks-wins", "title": "Payroll: QuickBooks Wins (Hands Down)" },
        { "id": "integrations-xero-wins-on-app-ecosystem", "title": "Integrations: Xero Wins on App Ecosystem" },
        { "id": "reporting-quickbooks-pulls-ahead", "title": "Reporting: QuickBooks Pulls Ahead" },
        { "id": "who-should-choose-xero", "title": "Who Should Choose Xero?" },
        { "id": "who-should-choose-quickbooks", "title": "Who Should Choose QuickBooks?" },
    ...
    "atAGlance": {
        ...
        "items": [
            ...
            { "label": "Target", "text": "Canadian SMEs choosing accounting software" },
            { "label": "Topic", "text": "Xero vs QuickBooks comparison" },
            { "label": "Xero Wins", "text": "Interface, e-commerce integrations, multi-currency" },
            { "label": "QuickBooks Wins", "text": "Built-in payroll, advanced reporting, phone support" },
            { "label": "Verdict", "text": "Both excellent—choose based on your specific needs" }
        ]
    },
    "author": "Seb Prost, CPA",
    "date": "December 4, 2023",
    "readTime": "12 min read",
    "tags": ["Xero", "QuickBooks", "Comparison", "Accounting Software", "Cloud Accounting"],
    "category": "Accounting Tools",
    "image": "/images/blog-heroes/hero_ledgerlogic_is_xero_worth_it.png"
}

json_str = json.dumps(new_post, indent=4)
